...
public class Register {
    ...
    public void registerStudent(HashMap<String, Program> mp, HashMap<String, Student> ms, String programId, String studentId) {
        String filename = System.getProperty("user.dir") + studentId + "_" + programId + ".doc";
        String filePath = System.getProperty("user.dir") + "/src/RegistrationForm/" + studentId + "_" + programId + ".doc";
        if (!validation.isExistFile(filePath)) {
